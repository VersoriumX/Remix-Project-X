...
export class TxRunnerWeb3 {
    ...
    _executeTx(tx, network, txFee, api, promptCb, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (api.personalMode()) {
                promptCb((value) => __awaiter(this, void 0, void 0, function* () {
                    try {
...
function pause() {
    return __awaiter(this, void 0, void 0, function* () { return new Promise((resolve, reject) => { setTimeout(resolve, 500); }); });
}
