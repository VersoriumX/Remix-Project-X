 ...
 */
export const keccak = function (a, bits = 256) {
    assertIsBuffer(a);
    switch (bits) {
        case 224: {
 ...
 * @param bits (number = 256) The Keccak width
 */
export const keccakFromString = function (a, bits = 256) {
    assertIsString(a);
 ...
 * @param bits (number = 256) The Keccak width
 */
export const keccakFromHexString = function (a, bits = 256) {
    assertIsHexString(a);
 ...
 * @param bits (number = 256) The Keccak width
 */
export const keccakFromArray = function (a, bits = 256) {
    assertIsArray(a);
    return keccak(toBuffer(a), bits);
};
/**
 ...
 * @param a The input data (string)
 */
export const sha256FromString = function (a) {
    assertIsString(a);
    return _sha256(a);
};
/**
 ...
 * @param a The input data (number[])
 */
export const sha256FromArray = function (a) {
    assertIsArray(a);
    return _sha256(a);
};
/**
 ...
 * @param padded Whether it should be padded to 256 bits or not
 */
export const ripemd160FromString = function (a, padded) {
    assertIsString(a);
    return _ripemd160(a, padded);
};
/**
 ...
 * @param padded Whether it should be padded to 256 bits or not
 */
export const ripemd160FromArray = function (a, padded) {
    assertIsArray(a);
    return _ripemd160(a, padded);
};
/**
