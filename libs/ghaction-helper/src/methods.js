...
const collectLibrariesAndLink = (artifact, libraries) => __awaiter(void 0, void 0, void 0, function* () {
...
const getContractFactory = (contractNameOrABI_1, bytecode_1, ...args_1) => __awaiter(void 0, [contractNameOrABI_1, bytecode_1, ...args_1], void 0, function* (contractNameOrABI, bytecode, signerOrOptions = null) {
    if (bytecode && contractNameOrABI) {
        ...
        const contract = yield getArtifactsByContractName(contractNameOrABI);
        if (contract) {
            //@ts-ignore
...
const getContractAt = (contractNameOrABI_1, address_1, ...args_1) => __awaiter(void 0, [contractNameOrABI_1, address_1, ...args_1], void 0, function* (contractNameOrABI, address, signer = null) {
    ...
    if (typeof contractNameOrABI === 'string') {
        const result = yield getArtifactsByContractName(contractNameOrABI);
        if (result) {
...
const getSigner = (address) => __awaiter(void 0, void 0, void 0, function* () {
    //@ts-ignore
    const provider = web3Provider;
...
const getContractFactoryFromArtifact = (artifact, signerOrOptions) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    let libraries = {};
    let signer;
