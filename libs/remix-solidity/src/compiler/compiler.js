...
import { isFunctionDescription, CompilerRetriggerMode } from './types';
/*
...
export class Compiler {
    ...
    loadWorkerHandler() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof (window) !== 'undefined' && Worker) {
                const ESWebWorker = yield import('../lib/es-web-worker/es-web-worker-handler');
     ...
     */
    internalCompile(files, missingInputs, timeStamp) {
     ...
     * @param source Source
     */
    onCompilationFinished(data, missingInputs, source, input, version, timeStamp) {
    ...
    loadWorker(url) {
        ...
        this.state.compileJSON = (source, timeStamp) => {
            var _a;
            if (source && source.sources) {
                const { optimize, runs, evmVersion, language, remappings, useFileConfiguration, configFileContent } = this.state;
                ...
                try {
                    if (useFileConfiguration) {
                        ...
                        if ((_a = compilerInput.settings.remappings) === null || _a === void 0 ? void 0 : _a.length)
                            compilerInput.settings.remappings.push(...remappings);
                        else
                            compilerInput.settings.remappings = remappings;
